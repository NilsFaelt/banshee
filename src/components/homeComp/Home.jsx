        ...
        <section className={Styles.section}>
          <div className={Styles.homeAboutBanshee}>
            ...
            <p>
              ...
              knowledge. The main focus is towards react and all the librarys
              and modules that comes with it, but feel free to share all your
              usable knowledge in here. <br /> Our goal is to keep it simple,
              and understandble.
